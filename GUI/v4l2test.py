from PIL import Image #pip3 install http://effbot.org/downloads/Imaging-1.1.6.tar.gz
import select
import v4l2py #sudo apt-get install libv4l-dev && sudo pip install v4l2capture
import cv2
import numpy as np
import time 
i = 0
