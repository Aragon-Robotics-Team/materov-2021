...
def horOrVert(x1, x2, y1, y2):
    ...
    if (angle >= 90 and angle < 135):
        horizontal = [x1, x2, y1, y2] #the last horizontal line is saved
        # print("horizontal")
        numH = numH + 1
    if (angle >= 135 and angle < 181):
        # print("vertical")
        vertical = [x1, x2, y1, y2] #the last vertical line is saved
        numV = numV + 1
...
def findPosition():
    ...
    if numV > 0:
        print("Number of Horizontal Lines: " + str(numV))
...
if __name__ == "__main__":
    img = cv2.imread("/Users/valeriefan/Desktop/flag.jpg")
    autoTransect(img)
